...
public class TuningLogValue {
    ...
    public String toString() {
        ...
        return onTimeMillis + D + dtf.format(dateTime) + D + speed + D + distance + D + rpm + D + lambda + D + starter + D + (autoGear ? "A" : "M") + gear + D + fuelCorrection + D + fuelConsumption + D + fuelConsumed + D + batteryVoltage + D + oilTemperature + D + waterTemperature + D + exhaustTemperature + D + brakeFront + D + brakeRear + D + ecuState + D + tuningState + System.lineSeparator();
    }
    ...
    public void setTuningState(TuningState tuningState) {
