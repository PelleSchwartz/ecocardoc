...
public class TeensySync {
	...
	public enum EcuEnum {
		...
		LOG_PERIOD("L_P"),
		TUNING_STATE("T_S"),
		TUNING_VALUE_MAX("T_MAX"),
		TUNING_VALUE_MIN("T_MIN"),
		TUNING_REQUEST_ON_OFF("T_O"),
		TUNING_IN_INIT_WAITING_FOR_LOG_SETUP("T_I_I"),
		// Values not sent to Teensy (used for local configuration save and load)
		TUNING_DISTANCE("TUDIS"),
		TUNING_VALUE_INDEX("TUIND"),
		TEST_VALUES("TEST"),
